# 🏠 GoldenTellus FDE Community

> 我们不培养六边形战士。
> FDE 不是一个角色，是一条流水线。
> 这个仓库是 GoldenTellus Organization 的总入口：从你的需求出发，找到下一站。
...
| 我想参与讨论、组队或活动 | 🤝 [goldentellus-community](https://github.com/GoldenTellus/goldentellus-community) |
| 我想贡献文章、案例、代码或模板 | 🤝 [贡献指南](./CONTRIBUTING.md) → 🗂️ [仓库导航](./docs/navigation.md) |
...
- [🗺️ 在线总导航](https://goldentellus.github.io/goldentellus-home/navigation/)
- [🌱 新人入口](https://goldentellus.github.io/goldentellus-home/for-beginner/)
- [🔧 FDE 入口](https://goldentellus.github.io/goldentellus-home/for-fde/)
- [🏢 企业入口](https://goldentellus.github.io/goldentellus-home/for-enterprise/)
- [🤝 贡献指南](https://goldentellus.github.io/goldentellus-home/CONTRIBUTING/)

## 📌 使用原则

- 不确定去哪：先回到本仓库，再按“有需求？从这里直达”选择路径。
- 先看 README 和模板，再提交内容或创建 Demo。
- 案例必须有来源、授权状态、脱敏说明，并区分事实、估算和推断。
- Demo 不提交 API Key、客户原始数据、个人敏感信息或未经授权的第三方资产。
